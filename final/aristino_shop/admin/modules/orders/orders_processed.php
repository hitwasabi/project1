...
<?php 
    ...
    $sql_order = "SELECT * FROM receipt INNER JOIN customer ON customer.CUS_ID=receipt.CUS_ID INNER JOIN receipt_status ON receipt_status.RECT_ID = receipt.RECT_ID WHERE receipt_status.STATUS = 2   ORDER BY receipt.RECT_ID DESC";
    ...
    $sql_pagination = "SELECT * FROM receipt INNER JOIN customer ON customer.CUS_ID=receipt.CUS_ID INNER JOIN receipt_status ON receipt_status.RECT_ID = receipt.RECT_ID WHERE receipt_status.STATUS = 2   ORDER BY receipt.RECT_ID DESC LIMIT $start,$rowPerPage";
                            ...
                            ?>      
                                <tr>
                                    ...
                                    <td class="form-group">
                                        ...
                                        <a href="modules/orders/orders_edit.php?RECT_ID=<?php echo $row['RECT_ID']; ?>&case=23" class="btn btn-success"><i class="glyphicon glyphicon-ok"></i> Xử lí</a>
                                    </td>
                                </tr>
                            <?php         
                                     }
