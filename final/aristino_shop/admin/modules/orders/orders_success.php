...
<?php 
    ...
    $sql_order = "SELECT * FROM receipt INNER JOIN customer ON customer.CUS_ID=receipt.CUS_ID INNER JOIN receipt_status ON receipt_status.RECT_ID = receipt.RECT_ID WHERE receipt_status.STATUS = 4   ORDER BY receipt.RECT_ID DESC";
    ...
    $sql_pagination = "SELECT * FROM receipt INNER JOIN customer ON customer.CUS_ID=receipt.CUS_ID INNER JOIN receipt_status ON receipt_status.RECT_ID = receipt.RECT_ID WHERE receipt_status.STATUS = 4  ORDER BY receipt.RECT_ID DESC LIMIT $start,$rowPerPage";
