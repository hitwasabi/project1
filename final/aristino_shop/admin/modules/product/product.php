...
<?php 
    ...
    $sql_product = "SELECT * FROM product INNER JOIN category ON product.CATE_ID = category.CATE_ID ORDER BY PRODUCT_ID DESC";
    ...
    $sql_pagination = "SELECT * FROM product INNER JOIN category ON product.CATE_ID = category.CATE_ID ORDER BY PRODUCT_ID DESC LIMIT $start,$rowPerPage";
				...
				<div class="panel panel-default">
					<div class="panel-body">
                        <table 
                            ...
                            ?>      
                                <tr>
                                    <td style=""><?php echo $row['PRODUCT_ID']; ?></td>
                                    <td style=""><?php echo $row['PRODUCT_NAME']; ?></td>
                                    <td style=""><?php echo $row['PRODUCT_PRICE']; ?> vnd</td>
                                    <td id = "img_col">
                                        <img width="70" height="100" src="images/<?php echo $row['PRODUCT_IMG']; ?>" />
                                    </td>
                                    <td>
                                    ...
                                    <td class="form-group">
                                        <a href="index.php?page=edit_product&PRODUCT_ID=<?php echo $row['PRODUCT_ID']; ?>" class="btn btn-primary"><i class="glyphicon glyphicon-pencil"></i></a>
                                        <a onclick="return confirmDel();" href="modules/product/del_product.php?PRODUCT_ID=<?php echo $row['PRODUCT_ID']; ?>" class="btn btn-danger"><i class="glyphicon glyphicon-remove"></i></a>
                                    </td>
                                </tr>
                            <?php         
                                    }
