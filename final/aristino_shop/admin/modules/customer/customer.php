...
<?php 
    ...
    $sql_customer = "SELECT * FROM customer  ORDER BY CUS_ID DESC";
    ...
    $sql_pagination = "SELECT * FROM customer ORDER BY CUS_ID DESC LIMIT $start,$rowPerPage";
...
?>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div id="toolbar" class="btn-group">
            <a href="index.php?page=add_customer" class="btn btn-success">
					...
					<div class="panel-body">
                        <table 
						    ...
						    <tr>
                                ...
                                <th data-field="phonenumber" data-sortable="true">SDT</th>
                                <th>Hành động</th>
						    </tr>
                            </thead>
                            ...
                            <?php  if(mysqli_num_rows($resultPagination) > 0) {
                                    ...
                                    <td class="form-group">
                                        <a href="index.php?page=edit_customer&CUS_ID=<?php echo $row['CUS_ID']; ?>" class="btn btn-primary"><i class="glyphicon glyphicon-pencil"></i></a>
                                        <a onclick="return confirmDel();" href="modules/customer/del_customer.php?CUS_ID=<?php echo $row['CUS_ID']; ?>" class="btn btn-danger"><i class="glyphicon glyphicon-remove"></i></a>
                                    </td>
                                </tr>
                            <?php         
                                    }
                            ...
                            <!-- <tbody>
                                ...
                                <tr>
                                    <td >1</td>
                                    <td >Nguyễn Anh Tú</td>
                                    <td >nat007@gmail.com</td>
                                    <td>09/09/2020</td>
                                    <td class="form-group">
                                        <a href="edit_customer.php" class="btn btn-primary"><i class="glyphicon glyphicon-pencil"></i></a>
