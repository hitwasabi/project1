...
if(isset($_POST['login'])) {
	...
	if(!isset($error['email']) &&  !isset($error['pass'])) {
		...
		$sql = "SELECT * FROM employee WHERE EMP_MAIL = '$email' && EMP_PASS='$pass'";
		...
		// if($email == "tu@gmail.com" && $pass == "123456") {
		// 	$_SESSION['email'] = "tu@gmail.com";
		// 	header("location: admin.php");
		// }else{
	...
	<div class="row">
		<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
			<div class="login-panel panel panel-default">
				<div class="panel-heading">Aristino Shop - Administrator</div>
