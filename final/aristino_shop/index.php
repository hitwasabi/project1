...
?>
        ...
        <div class="news">
          <div class="demuc">
          <h2>Bản tin mới trong hôm nay của Aristino</h2>
          </div>
          <br>
          <div class="tintuc">
          <a href="tintuc1.php">
          <image class='tintuc1' src="image/new1.png">
          </a>
          <a href="tintuc2.php">
          <image class='tintuc2' src="image/new2.png">
          </a>
          </div> 
            <br>
          <div class='tin_tuc'>
            <a href="tintuc3.php">
          <image class='tintuc3' src="image/new3.jpg">
          </a>
          <a href="tintuc4.php">
          <image class='tintuc4' src="image/new4.png">
          </a>
        </div>
        </div>
        <?php
